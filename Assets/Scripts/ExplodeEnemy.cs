...
public class ExplodeEnemy : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (distanceToPlayer <= enemyStats.explodeDist && !hasExploded)
        {
            // Explode if player is within range and the enemy hasn't exploded yet
            StartCoroutine("Explode");
            hasExploded = true; // Set the flag to true to prevent repeated explosions
        }
